...
extension ValueProperties on FormStateHelper {
  ...
  set pinValue(String? value) {
    ...
    if (_SetPinViewTextEditingControllers.containsKey(PinValueKey)) {
      _SetPinViewTextEditingControllers[PinValueKey]?.text = value ?? '';
    }
  }
...
String? getValidationMessage(String key) {
  ...
  String? validationMessageForKey = validatorForKey(
    _SetPinViewTextEditingControllers[key]!.text,
  );
